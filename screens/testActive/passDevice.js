...
export default function PassDevice({ navigation, route }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.body}>
                <Text style={styles.bodyText}>Pass the device to your test taker.</Text>
            </View>
            <View style={styles.footer}>
                <TouchableOpacity 
                onPress={()=>{navigation.navigate('preTest',{projectName:route.params.projectName,testData:route.params.testData})}}
                style={styles.button}>
