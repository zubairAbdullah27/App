...
export default function PassDeviceForNps({ navigation, route }) {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text></Text>
                <TouchableOpacity
                    onPress={() => { navigation.navigate('passDeviceAfterPreTest', { projectName: route.params.projectName, testData: route.params.testData, userName: route.params.userName, answer: route.params.answer }) }}
            ...
            <View style={styles.body}>
                <Text style={styles.bodyText}>Pass the device to your test taker, Please.</Text>
            </View>
            <View style={styles.footer}>
                <TouchableOpacity
                    onPress={() => { navigation.navigate('testActiveNps', { projectName: route.params.projectName, testData: route.params.testData, userName: route.params.userName, answer: route.params.answer, tasksData: route.params.tasksData }) }}
                    style={styles.button}>
