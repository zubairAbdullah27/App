...
export default function OnBoarding1({ navigation }) {
    ...
    return (
        <View style={styles.container}>
            <ImageBackground
                source={require('../../assets/icons/boarding/onBoarding1.png')}
                style={{ width: wp('100'), height: hp('100'), }}
                imageStyle={{ paddingLeft: wp('2') }}
            >
                <SafeAreaView style={styles.subView}>
                    <Text style={styles.headingText}>We are the guides on the mountains.</Text>
                    <TouchableOpacity
...
const styles = StyleSheet.create({
    ...
    headingText: {
        ...
        width: wp('65'), textAlign: 'left', paddingLeft: wp('2')
    },
    nextButton: {
